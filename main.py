...
try:
    ...
    print("Discord.py is not installed.\n"
          ...
          "https://github.com/kennethxd121/Kenbot")
    sys.exit(1)
...
class Bot(commands.Bot):
    ...
    async def shutdown(self, *, restart=False):
        """Gracefully quits Kenbot with exit code 0
...
def initialize(bot_class=Bot, formatter_class=Formatter):
    ...
    async def on_ready():
        ...
        print("\nOfficial server: https://discord.gg/jcPfXWX")
...
def interactive_setup(settings):
    ...
    if first_run:
        print("Kenbot - First run configuration\n")
    ...
    if first_run:
        ...
        print("\nThe configuration is done. Leave this window always open to"
              ...
              "Please read this guide for a good overview on how Kenbot works:\n"
              "https://github.com/kennethxd121/Kenbot"
...
def load_cogs(bot):
    ...
    if owner_cog is None:
        print("The owner cog is missing. It contains core functions without "
              "which kenbot cannot function. Reinstall.")
        exit(1)
