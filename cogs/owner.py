...
class Owner:
    ...
    async def serverprefix(self, ctx, *prefixes):
        """Sets Kenbot prefixes for this server
    ...
    async def _blacklist_add(self, user: GlobalUser):
        """Adds user to Kenbot global blacklist"""
    ...
    async def _blacklist_remove(self, user: GlobalUser):
        """Removes user from Kenbot global blacklist"""
    ...
    async def _whitelist_add(self, user: GlobalUser):
        """Adds user to Kenbot global whitelist"""
    ...
    async def _whitelist_remove(self, user: GlobalUser):
        """Removes user from Kenbot global whitelist"""
    ...
    @commands.command()
    async def info(self):
        """Shows info about Kenbot"""
        author_repo = "https://github.com/kennethxd121/Kenbot"
        red_repo = author_repo + "/Kenbot"
        server_url = "https://discord.gg/pUfKD9t"
        ...
        about = (
            "This is an instance of Kenbot an amazing Discord bot "
            "created by Kenneth\n\n"
        ...
        embed.add_field(name="About Kenbot", value=about, inline=False)
