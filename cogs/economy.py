...
default_settings = {"PAYDAY_TIME": 1200, "PAYDAY_CREDITS": 150,
                    "SLOT_MIN": 10, "SLOT_MAX": 2200, "SLOT_TIME": 0,
                    "REGISTER_CREDITS": 50}
...
PAYOUTS = {
    (SMReel.two, SMReel.two, SMReel.six) : {
        ...
        "phrase" : "JACKPOT! 226! Your bid has been multiplied * 500!"
    },
...
class Economy:
    ...
    async def register(self, ctx):
        """Registers an account at the Kenlabs bank"""
        ...
        try:
            ...
            await self.bot.say("{} You already have an account at the"
                               " Kenlabs bank.".format(author.mention))
        ...
        if not user:
            ...
            try:
                ...
                await self.bot.say("{} You don't have an account at the"
                                   " Kenlabs bank. Type `{}bank register`"
    ...
    async def _set(self, ctx, user: discord.Member, credits: SetParser):
        ...
        Examples:
            bank set @Username 26 - Sets 26 credits
            bank set @Username +2 - Adds 2 credits
            bank set @Username -6 - Removes 6 credits"""
        author = ctx.message.author
        try:
