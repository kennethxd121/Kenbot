...
class Bartender:
    """Buy a drink at the bar with Retarded currency"""
    ...
    async def buy(self, ctx, amount : int, drink):
        """Buy a drink with currency from Retarded cash"""
    ...
    async def register(self, ctx):
        """Opens the bar and registers the bot into Kenlabs bank."""
        ...
        if not bank.account_exists(botuser):
            ...
            await self.bot.say("{} already has an account at the Kenlabs bank.".format(botuser.mention))
